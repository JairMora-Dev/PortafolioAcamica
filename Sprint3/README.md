...
1. Accede a la instancia EC2 de AWS con ayuda del archivo **UbuntuSprint3.pem** enviado junto con el proyecto. Ubicandose al mismo nivel de carpetas donde se encuentra el archivo antes mencionado, ejecuta:
```bash
ssh -i UbuntuSprint3.pem ubuntu@'Dirección IPv4 pública de la instancia en AWS'
```
